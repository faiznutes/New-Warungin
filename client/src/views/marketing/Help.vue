    ...
    <section class="container mx-auto px-4 py-12 pb-20">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 hover:shadow-xl hover:border-emerald-500/50 transition cursor-pointer group" @click="selectedCategory = 'getting-started'">
            <div class="w-14 h-14 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-emerald-500 group-hover:text-white transition-colors duration-300">
               <span class="material-symbols-outlined text-emerald-600 text-3xl group-hover:text-white transition-colors">rocket_launch</span>
            </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 hover:shadow-xl hover:border-emerald-500/50 transition cursor-pointer group" @click="selectedCategory = 'features'">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 hover:shadow-xl hover:border-emerald-500/50 transition cursor-pointer group" @click="selectedCategory = 'billing'">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 hover:shadow-xl hover:border-emerald-500/50 transition cursor-pointer group" @click="selectedCategory = 'troubleshooting'">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 hover:shadow-xl hover:border-emerald-500/50 transition cursor-pointer group" @click="selectedCategory = 'api'">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 hover:shadow-xl hover:border-emerald-500/50 transition cursor-pointer group" @click="selectedCategory = 'security'">
        ...
        <div class="mb-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 transition group cursor-pointer">
              <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-emerald-600 transition">Cara Setup Awal Warungin</h3>
              <p class="text-slate-500 dark:text-slate-400 text-sm mb-4">Langkah demi langkah menyiapkan outlet pertama Anda.</p>
              <span class="text-emerald-600 text-sm font-bold flex items-center gap-1">Baca Selengkapnya <span class="material-symbols-outlined text-sm">arrow_forward</span></span>
            </div>

            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 transition group cursor-pointer">
              <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-emerald-600 transition">Cara Menambah Produk</h3>
              <p class="text-slate-500 dark:text-slate-400 text-sm mb-4">Panduan input produk, varian, dan manajemen stok.</p>
              <span class="text-emerald-600 text-sm font-bold flex items-center gap-1">Baca Selengkapnya <span class="material-symbols-outlined text-sm">arrow_forward</span></span>
            </div>

            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 transition group cursor-pointer">
              <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-emerald-600 transition">Konfigurasi Printer Struk</h3>
              <p class="text-slate-500 dark:text-slate-400 text-sm mb-4">Cara menghubungkan printer thermal bluetooth/USB.</p>
              <span class="text-emerald-600 text-sm font-bold flex items-center gap-1">Baca Selengkapnya <span class="material-symbols-outlined text-sm">arrow_forward</span></span>
            </div>

            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 transition group cursor-pointer">
              <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-emerald-600 transition">Download Laporan Bulanan</h3>
