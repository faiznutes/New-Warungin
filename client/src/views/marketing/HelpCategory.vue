      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <router-link 
            ...
            class="group bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 hover:shadow-lg transition flex items-start gap-4"
          >
            <div class="w-12 h-12 bg-emerald-50 dark:bg-emerald-900/30 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 transition">
            ...
            <div class="flex-1">
              ...
              <span class="text-emerald-600 text-sm font-bold flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity transform translate-x-[-10px] group-hover:translate-x-0">
                Baca Selengkapnya 
...
const categories = [
  { 
    ...
    iconColor: 'text-emerald-600' // Unified color
  },
  { 
    id: 'features', 
    label: 'Fitur Sistem', 
