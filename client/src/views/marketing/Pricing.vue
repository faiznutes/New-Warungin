  ...
  <div class="min-h-screen font-display bg-gradient-to-br from-[#f8f9fa] via-[#eef2f6] to-[#dce5f2] dark:from-[#101822] dark:via-[#15202e] dark:to-[#0f151e]">
    ...
    <section class="container mx-auto px-4 sm:px-6 py-12 sm:py-16 relative overflow-hidden">
      ...
      <div class="absolute inset-0 pointer-events-none z-0">
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-gradient-to-b from-blue-50/50 to-transparent dark:from-blue-400/5 dark:to-transparent"></div>
      ...
      <div class="flex flex-col items-center justify-center text-center max-w-4xl mx-auto relative z-10">
        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-wider mb-6">
        ...
        <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6 px-2 leading-tight">
          Investasi Terbaik untuk <br/><span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400">Pertumbuhan Bisnis</span>
        </h1>
    ...
    <section class="container mx-auto px-4 sm:px-6 py-8 sm:py-12 pb-12 sm:pb-20 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
        ...
        <!-- Boost Plan (Popular) -->
        <div class="flex flex-col bg-slate-900 dark:bg-slate-800 rounded-2xl shadow-2xl hover:shadow-2xl transition-all duration-300 transform lg:scale-105 border-4 border-blue-500 dark:border-blue-500 relative z-20">
          <div class="absolute top-0 inset-x-0 h-2 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-t-lg"></div>
      ...
      <div class="mt-24 max-w-6xl mx-auto px-4">
        <div class="text-center mb-16">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 text-xs font-bold uppercase tracking-wider mb-4">
