          ...
          <div class="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h2 class="text-xl sm:text-2xl font-bold text-gray-900">
                Test Demo Interaktif
              </h2>
              <p class="text-sm text-gray-600 mt-1">
                Coba langsung fitur-fitur Warungin tanpa perlu login. Klik tab di bawah untuk menjelajahi berbagai fitur.
              </p>
            </div>
          </div>
          <DemoPlayground />
            ...
            <div class="bg-gradient-to-br from-white to-primary-50 rounded-xl shadow-xl p-8 border border-primary-100">
              <div class="flex items-center space-x-3 mb-6">
                ...
                <h2 class="text-xl font-bold text-gray-900">
                  Fitur yang Akan Ditunjukkan dalam Demo
                </h2>
              </div>
              <ul class="space-y-3">
