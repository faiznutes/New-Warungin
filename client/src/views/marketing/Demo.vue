      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
          <div class="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Test Demo Interaktif</h2>
              <p class="text-sm text-gray-600 mt-1">Coba langsung fitur-fitur Warungin tanpa perlu login. Klik tab di bawah untuk menjelajahi berbagai fitur.</p>
            </div>
          </div>
          <DemoPlayground />
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
              ...
              <div class="space-y-2">
                <a href="mailto:faiznute07@gmail.com" class="flex items-center space-x-2 text-primary-600 hover:text-primary-700">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>faiznute07@gmail.com</span>
                </a>
                <a href="tel:085155043133" class="flex items-center space-x-2 text-primary-600 hover:text-primary-700">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
