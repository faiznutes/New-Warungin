<template>
  <div class="flex flex-col h-full">
    ...
    <div class="flex flex-col h-full">
      ...
      <div
        v-if="productLimit"
        class="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6 mx-4 sm:mx-6"
      >
        ...
        <div
          v-if="!productLimit.isUnlimited && productLimit.remaining === 0"
          ...
          <div class="flex items-start gap-2">
            ...
            <div class="flex-1">
              <p class="text-sm font-medium text-yellow-800">
                Limit produk telah tercapai
              </p>
              <p class="text-xs text-yellow-700 mt-1">
                Beli addon "Tambah Produk" untuk menambah slot produk, atau upgrade ke plan yang lebih tinggi.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <p class="text-gray-600 text-center max-w-md">
          Silakan pilih tenant terlebih dahulu untuk melihat produk
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div class="p-3 sm:p-4">
            <h3 class="font-semibold text-base sm:text-lg text-gray-900 mb-1 sm:mb-2 line-clamp-2">
              {{ product.name }}
            </h3>
