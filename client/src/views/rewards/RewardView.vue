    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8">
      ...
      <div class="text-center mb-6">
        ...
        <p class="text-gray-600">
          Tonton iklan hingga selesai untuk mendapatkan point
        </p>
      </div>
      ...
      >
        <div class="bg-gray-50 rounded-lg p-6 min-h-[300px] flex flex-col items-center justify-center">
          ...
          >
            ...
            <p
              v-else
              class="text-red-600 mb-4 font-semibold"
            >
              {{ ironSourceError }}
            </p>
            <div
            ...
            >
              ...
              <ul class="list-disc list-inside text-left space-y-1">
                <li v-if="trackingPreventionBlocked">
                  Nonaktifkan Tracking Prevention di pengaturan browser (Edge: Settings → Privacy → Tracking Prevention → Balanced/Off)
                </li>
      ...
      >
        <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 text-center">
          ...
          <p class="text-blue-600 text-sm mt-2">
            Tunggu hingga iklan selesai untuk mendapatkan point
          </p>
        </div>
      </div>
