        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr
              ...
              :key="submission.id"
              :class="['hover:bg-gray-50 transition', submission.isProcessed ? 'bg-green-50' : 'bg-white']"
            >
              <td class="px-6 py-4 whitespace-nowrap">
                <label class="flex items-center cursor-pointer">
                  ...
                  <span
                    ...
                    :class="submission.isProcessed ? 'text-green-700' : 'text-gray-600'"
                  >
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                ...
                <div
                  v-if="isOldSubmission(submission.createdAt)"
                  class="mt-1"
                >
      ...
      <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-auto">
        ...
        <div class="p-6 space-y-4">
          ...
          <div>
            ...
            <div class="flex items-center gap-2">
              ...
              <span
                ...
                :class="viewingSubmission.isProcessed ? 'text-green-700' : 'text-gray-600'"
              >
          ...
          <div>
            ...
            <p class="text-gray-900">
              {{ formatDate(viewingSubmission.createdAt) }} {{ formatTime(viewingSubmission.createdAt) }}
            </p>
          </div>
        </div>
...
const deleteSubmission = async (id: string) => {
  ...
  try {
    ...
    if (viewingSubmission.value?.id === id) {
