  ...
  <div class="flex flex-col gap-8">
    ...
    >
      <div class="flex items-start gap-3">
        <span
          class="material-symbols-outlined text-red-600 dark:text-red-400 mt-0.5"
          >error</span
        >
        <div class="flex-1">
          <p class="text-red-800 dark:text-red-300 font-bold text-sm mb-1">
            {{ addonError }}
          </p>
          <router-link
            to="/app/addons"
            class="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 text-xs font-medium underline flex items-center gap-1"
          >
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
      <div class="flex flex-col">
        <h2
          class="text-3xl font-bold text-[#0d141b] dark:text-white tracking-tight"
        >
          Advanced Analytics
        </h2>
        <p class="text-[#4c739a] dark:text-[#4c739a] mt-1">
          Sales predictions, forecasting, and deep insights.
        </p>
      </div>
      <button
        v-if="!addonError"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <!-- Sales Prediction -->
      <div
        class="bg-white dark:bg-slate-800 p-5 rounded-xl shadow-card border border-slate-100 dark:border-slate-700/50 relative overflow-hidden group hover:border-[#10b981]/50 transition-colors"
      >
        <div class="flex justify-between items-start mb-4">
          <div>
            <p
              class="text-xs font-bold text-[#4c739a] uppercase tracking-wider mb-1"
            >
              Sales Prediction
            </p>
          ...
          <div
            class="bg-indigo-50 dark:bg-indigo-900/30 p-2 rounded-xl text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform"
          >
        ...
        <div class="flex items-baseline gap-2">
          <h3 class="text-2xl font-bold text-[#0d141b] dark:text-white">
      ...
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div
            class="bg-blue-50 dark:bg-blue-900/30 p-2 rounded-xl text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform"
          >
            <span class="material-symbols-outlined text-[24px]"
              >trending_up</span
            >
        ...
        <div class="flex items-baseline gap-2">
          <h3
            class="text-2xl font-bold text-[#0d141b] dark:text-white"
            :class="predictions.trend > 0 ? 'text-blue-600' : 'text-red-600'"
          >
          ...
          >
            <span class="material-symbols-outlined text-[10px]">{{
              predictions.trend > 0 ? "arrow_upward" : "arrow_downward"
            }}</span>
      ...
      <!-- Top Products Count -->
      <div
        class="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden group hover:border-[#10b981]/50 transition-colors"
      >
        <div class="flex justify-between items-start mb-4">
          <div>
            <p
          ...
          <div
            class="bg-orange-50 dark:bg-orange-900/30 p-2 rounded-xl text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform"
          >
      ...
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div
            class="bg-purple-50 dark:bg-purple-900/30 p-2 rounded-xl text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform"
          >
            <span class="material-symbols-outlined text-[24px]"
              >model_training</span
            >
        ...
        <div class="flex flex-col gap-3">
          ...
          <div class="relative">
            ...
            <span
              class="absolute right-2 top-1.5 material-symbols-outlined text-[12px] text-[#4c739a] pointer-events-none"
              >expand_more</span
            >
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      >
        <div class="flex items-center justify-between mb-6">
          ...
          <span
            class="text-xs font-medium bg-slate-100 dark:bg-slate-700 text-[#4c739a] px-2 py-1 rounded-xl"
            >3 Bulan Ke Depan</span
          >
        </div>

        <div
          class="h-64 flex items-center justify-center bg-[#f6f7f8] dark:bg-slate-900/50 rounded-xl border border-dashed border-slate-200 dark:border-slate-700"
        >
          <div class="text-center">
            <div
              class="bg-white dark:bg-slate-800 p-4 rounded-full shadow-sm mx-auto mb-3 inline-block"
            >
            ...
            <p class="text-xs text-[#4c739a] mt-1">
              Implementasi chart menggunakan Chart.js
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="flex items-center justify-between mb-6">
          ...
          <span
            class="text-xs text-[#10b981] bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded-xl font-bold"
            >Best Sellers</span
          >
        </div>
          ...
          >
            <div class="flex items-center justify-between mb-1.5 text-sm">
              <div class="flex items-center gap-3">
                <span
                  class="w-5 h-5 flex items-center justify-center rounded bg-slate-100 dark:bg-slate-700 text-xs font-bold text-[#4c739a]"
                  >{{ index + 1 }}</span
                >
                <span
                  class="font-medium text-[#0d141b] dark:text-white truncate max-w-[150px] sm:max-w-xs"
                  >{{ product.name }}</span
                >
              </div>
    ...
    >
      <div class="flex items-center justify-between mb-6">
        ...
        <button
          @click="handleExportStoreComparison"
          class="text-sm text-[#4c739a] hover:text-[#10b981] font-medium flex items-center gap-1"
        >
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm text-left">
          <thead
            class="text-xs text-[#4c739a] uppercase bg-slate-50 dark:bg-slate-700/30"
          >
            <tr>
              ...
              <th class="px-6 py-3 font-bold text-right rounded-r-xl">
                Rata-rata Order
              </th>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
            <tr
              v-for="store in storeComparison"
              :key="store.id"
            ...
            >
              ...
              <td class="px-6 py-4 text-right font-medium text-[#10b981]">
                {{ formatCurrency(store.revenue) }}
              </td>
              <td class="px-6 py-4 text-right text-[#4c739a]">
                {{ store.orders }}
              </td>
              <td
                class="px-6 py-4 text-right text-[#0d141b] dark:text-white font-medium"
              >
                {{ formatCurrency(store.revenue / store.orders) }}
              </td>
            </tr>
          </tbody>
        </table>
    ...
    >
      <div class="flex items-center justify-between mb-6">
        ...
        <button
          ...
          class="text-sm text-[#10b981] font-bold hover:underline"
        >
          View All
        </button>
      </div>
      ...
      <div
        ...
        class="flex flex-col items-center justify-center py-12 text-center bg-[#f6f7f8] dark:bg-slate-900/50 rounded-xl border border-dashed border-slate-200 dark:border-slate-700"
      >
        <div class="bg-white dark:bg-slate-800 p-3 rounded-full shadow-sm mb-3">
          <span class="material-symbols-outlined text-[#4c739a] text-2xl"
            >folder_open</span
          >
        </div>
        <h4 class="text-sm font-bold text-[#0d141b] dark:text-white">
          No reports yet
        </h4>
        <p class="text-xs text-[#4c739a] mt-1 max-w-xs mx-auto">
          Create your first custom report to start analyzing specific data.
        </p>
      </div>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div class="flex items-start justify-between mb-3">
            <div
              class="p-2 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 rounded-xl"
            >
            ...
            >
              <button
                ...
                class="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded text-[#4c739a] hover:text-[#10b981]"
                title="Lihat"
              >
              ...
              <button
                ...
                class="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded text-[#4c739a] hover:text-green-600"
                title="Export"
              >
                <span class="material-symbols-outlined text-[18px]"
                  >download</span
          ...
          <h4 class="font-bold text-[#0d141b] dark:text-white mb-1 truncate">
            {{ report.name }}
          </h4>
          <p class="text-xs text-[#4c739a] mb-4 line-clamp-2">
            {{ report.description || "Tidak ada deskripsi" }}
          </p>

          <div
            class="flex items-center justify-between text-[10px] text-[#4c739a] pt-3 border-t border-slate-100 dark:border-slate-700"
          >
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-hidden flex flex-col"
        >
          <div
          ...
          <div class="p-6 overflow-y-auto">
            <div class="flex flex-col gap-4">
              <div>
                <label
                  class="block text-xs font-bold text-[#0d141b] dark:text-white uppercase tracking-wider mb-2"
                  >Nama Report</label
                >
                <input
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  <label
                    class="flex items-center gap-3 p-3 border border-slate-200 dark:border-slate-700 rounded-xl cursor-pointer hover:bg-[#f6f7f8] dark:hover:bg-slate-800 transition-colors"
                  >
                    <input
                      v-model="reportForm.metrics"
                      type="checkbox"
                      value="REVENUE"
                      class="h-4 w-4 text-[#10b981] rounded focus:ring-[#10b981]"
                    />
                    <span
                      class="text-sm font-medium text-[#0d141b] dark:text-white"
                      >Revenue</span
                    >
                  </label>
                  <label
          ...
          <div
            class="p-6 border-t border-slate-100 dark:border-slate-700 flex gap-3"
          >
            <button
              @click="showCustomReportModal = false"
...
const forecastMethod = ref<"moving_average" | "linear_regression">(
  "moving_average",
);
...
const loadAnalytics = async () => {
  ...
  loading.value = true;
  try {
    const [predictionsRes, productsRes, reportsRes, storeComparisonRes] =
      await Promise.all([
        api
        ...
        authStore.isSuperAdmin
          ...
          : api
              ...
              .catch(() => ({ data: { data: [] } })),
        // Store comparison from analytics endpoint
        api.get("/analytics/revenue-by-outlet").catch(() => ({ data: [] })),
      ]);
    ...
    storeComparison.value = (storeComparisonRes.data || []).map(
      (outlet: any) => ({
        id: outlet.outletId,
        name: outlet.outletName,
        revenue: outlet.revenue || 0,
        orders: outlet.orderCount || 0,
      }),
    );
  } catch (error: any) {
    ...
    if (error.response?.status === 403) {
      addonError.value =
        "Business Analytics & Insight addon diperlukan untuk mengakses fitur ini";
      await showError(
        "Business Analytics & Insight addon diperlukan untuk mengakses fitur ini",
      );
    } else {
...
const exportReport = async (report: CustomReport) => {
  try {
    const response = await api.get(
      `/analytics/custom-reports/${report.id}/export`,
      {
        responseType: "blob",
      },
    );
...
const saveCustomReport = async () => {
  try {
    ...
    await showError(
      error.response?.data?.message || "Gagal membuat custom report",
    );
  }
};
...
const handleExportStoreComparison = () => {
  ...
  const rows = storeComparison.value.map((s: any) => [
    ...
    s.revenue,
    s.orders,
    s.orders > 0 ? Math.round(s.revenue / s.orders) : 0,
  ]);
  ...
  link.setAttribute(
    "download",
    `store-comparison-${new Date().toISOString().split("T")[0]}.csv`,
  );
  document.body.appendChild(link);
  link.click();
  link.remove();
...
const handleViewAllReports = () => {
  ...
  document
    .querySelector('[data-section="custom-reports"]')
