    ...
    >
      <div class="flex items-center">
        ...
        <div class="flex-1">
          ...
          <router-link
            to="/app/addons"
            class="text-red-600 hover:text-red-800 text-sm underline mt-1 inline-block"
          >
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-gray-600">
          Prediksi penjualan, forecasting, dan custom reports
        </p>
      </div>
      <button
        v-if="!addonError"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div
          ...
          :class="predictions.trend > 0 ? 'text-green-600' : 'text-red-600'"
        >
