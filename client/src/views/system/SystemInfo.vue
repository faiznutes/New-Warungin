    ...
    <div class="mb-6 px-4 sm:px-6">
      <div class="flex flex-col gap-2">
        ...
        <p class="text-sm sm:text-base text-gray-600">
          Informasi lengkap tentang fitur dan kemampuan sistem
        </p>
      </div>
    </div>
      ...
      <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl shadow-lg border-2 border-purple-200 p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">
              9 addons premium yang dapat ditambahkan ke paket
            </p>
          </div>
        </div>
        <div
        ...
        >
          <!-- Resource Addons -->
          <div
            v-if="resourceAddons.length > 0"
            class="p-4 bg-white rounded-lg border border-purple-200"
          >
            <h4 class="font-semibold text-gray-900 mb-2">
              Addon Sumber Daya
            </h4>
          ...
          <!-- Marketing & Delivery -->
          <div
            v-if="marketingAddons.length > 0"
            class="p-4 bg-white rounded-lg border border-purple-200"
          >
            <h4 class="font-semibold text-gray-900 mb-2">
              Pemasaran & Pengiriman
              <span
                v-if="marketingAddons.some(a => a.comingSoon)"
                class="text-xs text-yellow-600 font-normal"
              >(Coming Soon)</span>
            </h4>
            <ul class="text-sm text-gray-700 space-y-1">
              <li
                v-for="addon in marketingAddons"
                :key="addon.id"
              >
                • {{ addon.name }}
                <span
          ...
          <!-- Analytics & Reporting -->
          <div
            v-if="analyticsAddons.length > 0 || reportingAddons.length > 0"
            class="p-4 bg-white rounded-lg border border-purple-200"
          >
            <h4 class="font-semibold text-gray-900 mb-2">
              Analitik & Laporan
            ...
            <ul class="text-sm text-gray-700 space-y-1">
              <li
                v-for="addon in analyticsAddons"
                :key="addon.id"
              >
                • {{ addon.name }} ({{ formatPrice(addon.price) }}/bulan)
              </li>
              <li
                v-for="addon in reportingAddons"
                :key="addon.id"
              >
                • {{ addon.name }} ({{ formatPrice(addon.price) }}/bulan)
              </li>
          ...
          <!-- Financial & Inventory -->
          <div
            v-if="financeAddons.length > 0 || inventoryAddons.length > 0"
            class="p-4 bg-white rounded-lg border border-purple-200"
          >
            <h4 class="font-semibold text-gray-900 mb-2">
              Keuangan & Inventori
            ...
            <ul class="text-sm text-gray-700 space-y-1">
              ...
              <li
                v-for="addon in inventoryAddons"
                :key="addon.id"
              >
                • {{ addon.name }} ({{ formatPrice(addon.price) }}/bulan)
                <span
          ...
          <!-- AI/ML & Advanced -->
          <div
            v-if="aiMlAddons.length > 0 || receiptAddons.length > 0 || outletAddons.length > 0"
            class="p-4 bg-white rounded-lg border border-purple-200"
          >
            <h4 class="font-semibold text-gray-900 mb-2">
              AI/ML & Lanjutan
            ...
            <ul class="text-sm text-gray-700 space-y-1">
              ...
              <li
                v-for="addon in receiptAddons"
                :key="addon.id"
              >
                • {{ addon.name }} ({{ formatPrice(addon.price) }}/bulan)
              </li>
              <li
                v-for="addon in outletAddons"
                :key="addon.id"
              >
                • {{ addon.name }} ({{ formatPrice(addon.price) }}/bulan)
              </li>
      ...
      <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">
              Mengelola toko dan operasional (berdasarkan tier & addons)
            </p>
          </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
          ...
          <div class="p-4 bg-green-50 rounded-lg border border-green-200">
            <h4 class="font-semibold text-gray-900 mb-2">
              Pemasaran <span class="text-xs text-yellow-600 font-normal">(Coming Soon)</span>
            </h4>
            <ul class="text-sm text-gray-700 space-y-1">
      ...
      <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">
              Operasional kasir dan transaksi
            </p>
          </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        ...
        <div class="mt-4 space-y-3">
          <div class="p-4 bg-white rounded-lg border border-purple-200">
            ...
            <p class="text-sm text-gray-700">
              Data disimpan maksimal <span class="font-bold text-purple-600">2 tahun</span> ke belakang dari tanggal saat ini.
            </p>
          </div>
          <div class="p-4 bg-white rounded-lg border border-purple-200">
            <h4 class="font-semibold text-gray-900 mb-2">
            ...
            <p class="text-sm text-gray-700">
              Sistem mendukung laporan per tahun untuk memudahkan analisis data historis.
            </p>
          </div>
          <div class="p-4 bg-yellow-50 rounded-lg border border-yellow-300">
            ...
            <p class="text-sm text-gray-700">
              Fitur Archive Management saat ini <span class="font-bold text-yellow-700">tidak diaktifkan</span>. Hanya Super Admin yang dapat mengakses fitur ini.
            </p>
          </div>
        </div>
      </div>
