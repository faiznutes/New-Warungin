  ...
  <div class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50 flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        >
          <h1 class="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-600 via-purple-600 to-purple-700 bg-clip-text text-transparent">
            Warungin
          </h1>
          <p class="text-gray-600">
            Sistem Modern untuk UMKM
          </p>
        </router-link>
      </div>
        ...
        >
          ...
          <div class="flex items-center">
            <input
              ...
              style="min-height: 1rem; min-width: 1rem; height: 1rem; width: 1rem;"
            />
            <label
              for="remember-me"
            ...
            >
              ...
              >
                ...
                <path
                  class="opacity-75"
                  fill="currentColor"
                  d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12c0-4.418 3.582-8 8-8v4a4 4 0 00-4 4c0 1.104.896 2 2 2h2z"
                />
              </svg>
              Memproses...
            </span>
