<template>
  <div class="flex flex-col h-full">
    ...
    <div
      v-if="loading"
      class="flex items-center justify-center py-12 px-4 sm:px-6"
    >
    ...
    >
      ...
      <div
        ...
        class="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-300 rounded-xl p-6 shadow-lg"
      >
