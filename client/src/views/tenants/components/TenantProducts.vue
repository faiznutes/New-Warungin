<template>
  <div class="flex flex-col h-full">
    ...
    <div v-if="loading" class="flex items-center justify-center py-12">
      <div
        class="w-12 h-12 border-4 border-primary-600 border-t-transparent rounded-full animate-spin"
      ></div>
    </div>

    <div
      v-else-if="filteredProducts.length === 0"
      class="flex flex-col items-center justify-center py-12 bg-white rounded-xl"
    >
      <svg
    ...
    >
      ...
      >
        <div
          class="aspect-w-16 aspect-h-9 bg-gray-200 flex items-center justify-center overflow-hidden"
        >
          <img
            v-if="product.image"
            :src="product.image"
          ...
          />
          <span v-else-if="product.emoji" class="text-6xl sm:text-7xl">{{
            product.emoji
          }}</span>
          <div
            v-else
