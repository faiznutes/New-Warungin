        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-blue-100 text-sm">
              Pelajari tentang langganan, addons, dan cara penggunaannya
            </p>
          </div>
          <button
            ...
            <div class="flex items-center space-x-3">
              ...
              <div class="text-left">
                ...
                <p class="text-sm text-gray-600">
                  Panduan lengkap untuk memulai dan menggunakan sistem
                </p>
              </div>
            </div>
            <svg
                ...
                <div class="space-y-3 ml-2">
                  <div>
                    ...
                    <p class="text-gray-700 mt-1">
                      Lihat ringkasan penjualan hari ini, produk terlaris, grafik penjualan, dan statistik penting lainnya. Quick Insight menampilkan analisis cepat untuk pengambilan keputusan.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">🛍️ Produk:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola semua produk toko Anda. Tambah produk baru dengan foto, kategori, harga, stok, dan barcode. Edit atau hapus produk yang sudah tidak dijual. Atur alert stok minimum untuk notifikasi otomatis saat stok menipis.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">🛒 POS (Point of Sale):</strong>
                    <p class="text-gray-700 mt-1">
                      Sistem kasir untuk transaksi langsung. Pilih produk, atur jumlah, pilih customer/member, terapkan diskon, dan proses pembayaran. Cetak struk langsung setelah transaksi selesai.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">📋 Pesanan:</strong>
                    <p class="text-gray-700 mt-1">
                      Lihat semua pesanan yang masuk, filter berdasarkan status (Pending, Processing, Completed, Cancelled). Edit pesanan yang belum dibayar, update status, dan kirim ke dapur jika ada item makanan/minuman.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">👥 Pelanggan:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola data pelanggan dan member. Tambah pelanggan baru, lihat riwayat pembelian, dan kelola member dengan diskon khusus. Member bisa mendapatkan diskon otomatis saat checkout.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">🏪 Store:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola outlet/cabang toko Anda. Tambah store baru, edit informasi store, atau nonaktifkan store yang sudah tidak beroperasi. Setiap store bisa memiliki produk dan laporan terpisah.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">📈 Laporan:</strong>
                    <p class="text-gray-700 mt-1">
                      Akses berbagai laporan penjualan dan keuangan. Filter berdasarkan tanggal, export ke Excel/PDF, dan analisis performa bisnis. Lihat laporan penjualan harian, bulanan, produk terlaris, dan laporan keuangan.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">📊 Business Analytics:</strong>
                    <p class="text-gray-700 mt-1">
                      Fitur advanced analytics (jika addon aktif) untuk analisis mendalam: prediksi penjualan, tren produk, laporan laba rugi, dan insight bisnis yang lebih detail.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">👤 User:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola semua user yang memiliki akses ke sistem. Tambah user baru, edit permission, aktifkan/nonaktifkan user, dan reset password jika diperlukan.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">🎫 Diskon:</strong>
                    <p class="text-gray-700 mt-1">
                      Buat aturan diskon otomatis: diskon berdasarkan jumlah pembelian, diskon bundle (beli A+B dapat diskon), atau diskon produk tertentu. Diskon akan otomatis diterapkan saat checkout.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">💳 Berlangganan:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola paket langganan Anda. Upgrade paket, perpanjang langganan, lihat riwayat pembayaran, dan aktifkan addon tambahan sesuai kebutuhan bisnis.
                    </p>
                  </div>
                  <div>
                    <strong class="text-green-800">⚙️ Pengaturan Toko:</strong>
                    <p class="text-gray-700 mt-1">
                      Konfigurasi lengkap toko: profil toko, template struk, pengaturan printer, metode pembayaran, dan preferensi sistem lainnya.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                ...
                <div class="space-y-3 ml-2">
                  <div>
                    ...
                    <p class="text-gray-700 mt-1">
                      Lihat ringkasan penjualan hari ini dan target harian. Monitor transaksi yang sudah diproses dan pendapatan yang sudah terkumpul.
                    </p>
                  </div>
                  <div>
                    <strong class="text-yellow-800">🛒 POS (Point of Sale):</strong>
                    <p class="text-gray-700 mt-1">
                      Menu utama untuk melayani pelanggan. Scan barcode atau pilih produk, atur jumlah, pilih customer/member, terapkan diskon jika ada, pilih metode pembayaran, dan proses transaksi. Cetak struk setelah pembayaran berhasil.
                    </p>
                  </div>
                  <div>
                    <strong class="text-yellow-800">🛍️ Produk:</strong>
                    <p class="text-gray-700 mt-1">
                      Lihat daftar produk yang tersedia, cek stok real-time, dan cari produk dengan cepat. Jika memiliki permission, bisa edit harga atau stok produk.
                    </p>
                  </div>
                  <div>
                    <strong class="text-yellow-800">📋 Pesanan:</strong>
                    <p class="text-gray-700 mt-1">
                      Lihat pesanan yang masuk, filter berdasarkan status. Edit pesanan yang belum dibayar, update status pesanan, dan kirim notifikasi ke dapur jika ada item yang perlu dimasak.
                    </p>
                  </div>
                  <div>
                    <strong class="text-yellow-800">👥 Pelanggan:</strong>
                    <p class="text-gray-700 mt-1">
                      Cari atau tambah pelanggan baru saat transaksi. Lihat riwayat pembelian pelanggan dan cek status member untuk menerapkan diskon otomatis.
                    </p>
                  </div>
                  <div>
                    <strong class="text-yellow-800">📈 Laporan:</strong>
                    <p class="text-gray-700 mt-1">
                      Lihat laporan penjualan harian yang sudah diproses oleh Anda. Filter berdasarkan tanggal untuk melihat performa penjualan.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-red-50 p-4 rounded-lg border border-red-200">
                ...
                <div class="space-y-3 ml-2">
                  <div>
                    ...
                    <p class="text-gray-700 mt-1">
                      Lihat ringkasan pesanan yang perlu diproses hari ini. Monitor jumlah pesanan pending, sedang dimasak, dan sudah selesai.
                    </p>
                  </div>
                  <div>
                    <strong class="text-red-800">🍽️ Pesanan Dapur:</strong>
                    <p class="text-gray-700 mt-1">
                      Menu utama untuk mengelola pesanan makanan/minuman. Lihat semua pesanan yang dikirim ke dapur, update status: <strong>Pending</strong> (baru masuk) → <strong>Processing</strong> (sedang dimasak) → <strong>Ready</strong> (sudah siap diambil). Notifikasi real-time akan muncul saat ada pesanan baru.
                    </p>
                  </div>
                  <div>
                    <strong class="text-red-800">📋 Detail Pesanan:</strong>
                    <p class="text-gray-700 mt-1">
                      Klik pesanan untuk melihat detail lengkap: item apa saja yang perlu dimasak, jumlah, catatan khusus dari pelanggan, dan waktu pesanan masuk. Update status per item jika ada yang sudah selesai lebih dulu.
                    </p>
                  </div>
                  <div>
                    <strong class="text-red-800">🔔 Notifikasi Real-time:</strong>
                    <p class="text-gray-700 mt-1">
                      Sistem akan memberikan notifikasi suara dan visual saat ada pesanan baru yang masuk ke dapur. Pastikan browser tidak di-block untuk notifikasi.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                ...
                <div class="space-y-3 ml-2">
                  <div>
                    ...
                    <p class="text-gray-700 mt-1">
                      Lihat overview lengkap operasional toko: penjualan hari ini, produk terlaris, grafik performa, dan statistik penting lainnya untuk monitoring bisnis.
                    </p>
                  </div>
                  <div>
                    <strong class="text-indigo-800">🛍️ Produk:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola produk dengan akses penuh: tambah, edit, hapus produk, atur stok, update harga, dan kelola kategori. Monitor produk dengan stok menipis dan lakukan restock.
                    </p>
                  </div>
                  <div>
                    <strong class="text-indigo-800">📋 Pesanan:</strong>
                    <p class="text-gray-700 mt-1">
                      Monitor semua pesanan di toko. Filter berdasarkan status, outlet, atau tanggal. Edit pesanan jika diperlukan, update status, cancel pesanan yang dibatalkan, dan pastikan semua pesanan terproses dengan baik.
                    </p>
                  </div>
                  <div>
                    <strong class="text-indigo-800">👥 Pelanggan:</strong>
                    <p class="text-gray-700 mt-1">
                      Kelola data pelanggan dan member. Tambah pelanggan baru, edit informasi, lihat riwayat pembelian, dan kelola member dengan diskon khusus.
                    </p>
                  </div>
                  <div>
                    <strong class="text-indigo-800">📈 Laporan:</strong>
                    <p class="text-gray-700 mt-1">
                      Akses laporan lengkap untuk analisis bisnis. Lihat laporan penjualan harian/bulanan, produk terlaris, laporan keuangan, dan export ke Excel/PDF untuk presentasi atau arsip.
                    </p>
                  </div>
                  <div>
                    <strong class="text-indigo-800">📊 Business Analytics:</strong>
                    <p class="text-gray-700 mt-1">
                      Jika addon aktif, akses advanced analytics untuk analisis mendalam: prediksi penjualan, tren produk, laporan laba rugi, dan insight bisnis yang lebih detail untuk pengambilan keputusan strategis.
                    </p>
                  </div>
                  <div>
                    <strong class="text-indigo-800">🎫 Diskon:</strong>
                    <p class="text-gray-700 mt-1">
                      Buat dan kelola aturan diskon: diskon berdasarkan jumlah pembelian, diskon bundle, atau diskon produk tertentu. Aktifkan/nonaktifkan diskon sesuai kebutuhan promosi.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <div class="text-left">
                ...
                <p class="text-sm text-gray-600">
                  Pelajari tentang paket yang tersedia
                </p>
              </div>
            </div>
            <svg
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <div class="text-left">
                ...
                <p class="text-sm text-gray-600">
                  Fitur tambahan untuk meningkatkan produktivitas
                </p>
              </div>
            </div>
            <svg
        ...
        <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <div class="text-left">
                <h3 class="font-semibold text-gray-900">
                  Cara Penggunaan Addons
                </h3>
                <p class="text-sm text-gray-600">
                  Panduan menggunakan fitur addon yang aktif
                </p>
              </div>
            </div>
            <svg
