<template>
  <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
    ...
    <div
      v-else-if="error"
      class="text-center py-4 text-red-600 text-sm"
    >
      {{ error }}
    </div>
    ...
    >
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
          <p class="text-xs text-gray-600 mb-1">
            {{ periodLabel }} Transaksi
          </p>
          <p class="text-2xl font-bold text-gray-900">
            {{ insight.today.transactions }}
          </p>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 border border-blue-200">
          <p class="text-xs text-gray-600 mb-1">
            {{ periodLabel }} Pendapatan
          </p>
          <p class="text-2xl font-bold text-gray-900">
            {{ formatCurrency(insight.today.revenue) }}
          </p>
          <div class="flex items-center mt-2">
            <span 
      ...
      <div class="border-t pt-4">
        ...
        <div
          v-if="insight.today.topProducts.length === 0"
