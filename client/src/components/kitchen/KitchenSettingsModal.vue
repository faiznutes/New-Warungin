        ...
        >
          <div class="bg-white dark:bg-slate-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div
                class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-slate-100 dark:bg-slate-700 sm:mx-0 sm:h-10 sm:w-10"
              >
                <span
                ...
                <div class="mt-4 space-y-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <label
                        for="toggle"
                        class="toggle-label block overflow-hidden h-6 rounded-full bg-blue-500 cursor-pointer"
                      ></label>
                    </div>
                  </div>
                </div>
          ...
          <div
            class="bg-gray-50 dark:bg-slate-700/30 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse"
          >
            <button
              type="button"
...
const canSwitchStore = computed(() => {
  return ["ADMIN_TENANT", "SUPER_ADMIN", "SUPERVISOR"].includes(
    authStore.user?.role || "",
  );
});
