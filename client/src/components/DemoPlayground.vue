<template>
  <div class="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
    ...
    <div class="border-b border-gray-200 bg-gray-50">
      <div
        class="flex overflow-x-auto scrollbar-hide scroll-smooth"
        role="tablist"
        aria-label="Fitur demo Warungin"
      >
        <button
          v-for="tab in tabs"
          :key="tab.id"
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
              ...
              >
                ...
                <p class="text-xs mt-1 text-gray-400">
                  Demo Mode - Login untuk transaksi penuh
                </p>
              </div>
              <div
                v-else
                class="space-y-2 mb-4 max-h-64 overflow-y-auto scrollbar-thin"
              >
                <div
                  v-for="item in cart"
                  :key="item.id"
        ...
        >
          ...
          <div class="bg-white rounded-lg shadow-sm p-5 border border-gray-200">
            ...
            <p class="text-xs text-center text-gray-500 mt-3">
              Login untuk export laporan penuh
            </p>
          </div>
        </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
            ...
            <div class="overflow-x-auto">
              <table
                ...
                aria-label="Daftar pelanggan demo"
              >
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm text-primary-600 font-semibold">
                      {{ customer.points }}
                    </td>
                  </tr>
                </tbody>
