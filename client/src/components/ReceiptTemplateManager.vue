<template>
  ...
  >
    <div
      class="bg-white rounded-xl shadow-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto"
    >
      <div class="p-4 sm:p-6">
        <div class="flex items-center justify-between mb-4 sm:mb-6">
          <h3 class="text-xl sm:text-2xl font-bold text-gray-900">
            Kelola Template Struk
          </h3>
          <button
            @click="$emit('close')"
        ...
        <div v-if="selectedTemplate" class="border-t pt-6">
          ...
          <div class="bg-gray-50 rounded-xl p-4 sm:p-6">
            <div
              ...
              :class="[
                getPaperSizeClass(selectedTemplate.paperSize),
                getTemplateContainerClass(selectedTemplate.templateType),
              ]"
              :style="{
            ...
            >
              ...
              >
                <h1
                  :class="getTemplateTitleStyle(selectedTemplate.templateType)"
                >
                  Nama Toko
                </h1>
              ...
              <div
                :class="[
                  'border-t border-b py-4 mb-4',
                  getTemplateContentStyle(selectedTemplate.templateType),
                ]"
              >
                <div
                  :class="[
                    'flex justify-between text-sm mb-2',
                    getTemplateItemStyle(selectedTemplate.templateType),
                  ]"
                >
                  <span>Item 1</span>
                  <span>Rp 10.000</span>
              ...
              <div
                :class="getTemplateTotalStyle(selectedTemplate.templateType)"
              >
                <span>Total:</span>
                <span>Rp 10.000</span>
              </div>
              <div
                :class="getTemplateFooterStyle(selectedTemplate.templateType)"
              >
...
const saveTemplate = async () => {
  try {
    if (editingTemplate.value) {
      await api.put(
        `/receipts/templates/${editingTemplate.value.id}`,
        templateForm.value,
      );
...
const deleteTemplate = async (id: string) => {
  ...
  try {
    ...
    await showError(
      error.response?.data?.message || "Gagal menghapus template",
    );
  }
};
