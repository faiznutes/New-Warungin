      ...
      <div class="flex flex-col h-full">
        ...
        <div class="p-6 border-b border-green-600 flex-shrink-0">
          ...
          >
            ...
            <span class="ml-2 px-2 py-1 text-xs bg-green-600 text-green-100 rounded-full">{{ tenantLabel }}</span>
          </router-link>
        </div>
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
          ...
          <router-link
            to="/app/dashboard"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 text-green-100 hover:bg-green-600 hover:text-white group mb-2"
          ...
          <div
            ...
            class="pt-4 mt-4 border-t border-green-600"
          >
            <button
              class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-green-300 uppercase tracking-wider hover:text-green-200 transition-colors"
          ...
          <div
            v-if="authStore.user?.role === 'ADMIN_TENANT' || authStore.user?.role === 'SUPERVISOR' || authStore.user?.role === 'CASHIER'"
            class="pt-4 mt-4 border-t border-green-600"
          >
            <button
              class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-green-300 uppercase tracking-wider hover:text-green-200 transition-colors"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span class="font-medium">Laporan Lanjutan</span>
                </router-link>
                ...
                >
                  ...
                  <span class="font-medium">Manajemen Keuangan</span>
                </router-link>
                ...
                >
                  ...
                  <span class="font-medium">Fitur AI/ML</span>
                </router-link>
              </div>
            </div>
          </div>
          ...
          <div
            v-if="authStore.user?.role === 'ADMIN_TENANT' && hasDeliveryMarketing"
            class="pt-4 mt-4 border-t border-green-600"
          >
            <button
              class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-green-300 uppercase tracking-wider hover:text-green-200 transition-colors"
            ...
            >
              <span>Pemasaran & Pengiriman</span>
              <svg
                class="w-4 h-4 transition-transform duration-200"
            ...
            >
              ...
              >
                ...
                <span class="font-medium">Template Email</span>
              </router-link>
              ...
              >
                ...
                <span class="font-medium">Analitik Email</span>
              </router-link>
              ...
              >
                ...
                <span class="font-medium">Penjadwal Email</span>
              </router-link>
              ...
              >
                ...
                <span class="font-medium">Interaksi Pelanggan</span>
              </router-link>
              ...
              >
                ...
                <span class="font-medium">Pesanan Pengiriman</span>
              </router-link>
            </div>
          </div>
          ...
          <div
            v-if="authStore.user?.role === 'ADMIN_TENANT' && (currentPlan === 'PRO' || currentPlan === 'CUSTOM' || hasInventoryManagement)"
            class="pt-4 mt-4 border-t border-green-600"
          >
            <button
              class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-green-300 uppercase tracking-wider hover:text-green-200 transition-colors"
            ...
            >
              ...
              >
                ...
                <span class="font-medium">Pesanan Pembelian</span>
              </router-link>
          ...
          >
            ...
            >
              ...
              <router-link
                v-if="authStore.user?.role === 'ADMIN_TENANT' && hasMultiOutlet"
                to="/app/stores"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 text-green-100 hover:bg-green-600 hover:text-white group"
                active-class="bg-green-600 text-white font-semibold shadow-lg"
                @click="closeSidebarOnMobile"
              ...
              <router-link
                v-if="authStore.user?.role === 'ADMIN_TENANT' && hasDiscounts"
                to="/app/discounts"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 text-green-100 hover:bg-green-600 hover:text-white group"
                active-class="bg-green-600 text-white font-semibold shadow-lg"
                @click="closeSidebarOnMobile"
...
const pageTitle = computed(() => {
  const titles: Record<string, string> = {
    ...
    '/app/reports/advanced': 'Laporan Lanjutan',
    '/app/finance/management': 'Manajemen Keuangan',
    '/app/ai-ml': 'Fitur AI/ML',
  };
