      ...
      <div class="flex flex-col h-full">
        ...
        <div class="p-6 flex items-center gap-3">
          ...
          <div class="flex flex-col">
            ...
            <p class="text-xs font-medium text-slate-500 dark:text-slate-400 tracking-wide uppercase">Kasir Mode</p>
          </div>
        </div>
        ...
        <nav class="flex-1 px-4 py-4 gap-2 flex flex-col overflow-y-auto">
          ...
          <router-link
            ...
            to="/app/products"
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors"
            :class="[$route.path === '/app/products' ? 'bg-primary/10 text-primary font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200']"
            @click="closeSidebarOnMobile"
          >
          ...
          <router-link
            to="/app/pos"
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors"
            :class="[$route.path === '/app/pos' ? 'bg-primary/10 text-primary font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200']"
            @click="closeSidebarOnMobile"
          >
            <span class="material-symbols-outlined" :class="{ 'filled': $route.path === '/app/pos' }">point_of_sale</span>
            <span>POS</span>
          </router-link>
          ...
          <router-link
            ...
            to="/app/orders"
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors"
            :class="[$route.path === '/app/orders' ? 'bg-primary/10 text-primary font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200']"
            @click="closeSidebarOnMobile"
          >
          ...
          <router-link
            ...
            to="/app/customers"
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors"
            :class="[$route.path === '/app/customers' ? 'bg-primary/10 text-primary font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200']"
            @click="closeSidebarOnMobile"
          >
          ...
          <router-link
            ...
            to="/app/reports"
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors"
            :class="[$route.path === '/app/reports' ? 'bg-primary/10 text-primary font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200']"
            @click="closeSidebarOnMobile"
          >
          ...
          <router-link
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors"
            :class="[$route.path === '/app/cashier/cash-shift' ? 'bg-primary/10 text-primary font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200']"
            @click="closeSidebarOnMobile"
          >
