        ...
        <div class="flex items-center justify-between px-4 py-4">
          ...
          <div class="flex items-center space-x-4 flex-1 lg:flex-none">
            <h1
              ...
              :class="pageTitle === 'Warungin' ? 'bg-gradient-to-r from-blue-600 via-purple-600 to-purple-700 bg-clip-text text-transparent' : 'text-gray-900'"
            >
              {{ pageTitle }}
            </h1>
          </div>
          ...
          <div
            v-if="authStore.isSuperAdmin && authStore.tenants.length > 0"
